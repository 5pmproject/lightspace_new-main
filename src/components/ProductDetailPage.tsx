    ...
    <div className="bg-[#ffffff] relative size-full">
      ...
      <div className="absolute left-0 right-0 top-[449px] bottom-[100px] overflow-y-auto">
        <div className="px-6 py-6 space-y-6">
          {/* Product Info */}
          <div>
            <p className="text-[18px] font-['Inter:Regular',_sans-serif] text-[#1a1a1a] font-medium mb-2">
              {product.price}
            </p>
            <p className="text-[14px] font-['Inter:Regular',_sans-serif] text-[#757575]">
              {product.brand} • {product.room} • {product.style}
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-[16px] font-['Inter:Regular',_sans-serif] text-[#757575] leading-[20px] mb-3">
              {product.location}
            </p>
            ...
            <div className="flex flex-wrap gap-2 mb-6">
              {product.features.map((feature, index) => (
                <span 
                  key={index}
                  className="px-3 py-1 bg-[#f5f5f5] text-[#1a1a1a] text-[12px] rounded-full font-medium"
                >
                  {feature}
                </span>
              ))}
            ...
            <div className="bg-[#f9f9f9] p-4 rounded-lg">
              <h3 className="text-[16px] font-medium text-[#1a1a1a] mb-3">기술 사양</h3>
              <div className="grid grid-cols-2 gap-3 text-[13px]">
                <div>
                  <span className="text-[#757575]">전력</span>
                  <p className="text-[#1a1a1a] font-medium">{product.power}</p>
                </div>
                <div>
                  <span className="text-[#757575]">색온도</span>
                  <p className="text-[#1a1a1a] font-medium">{product.colorTemperature}</p>
                </div>
                <div>
                  <span className="text-[#757575]">광량</span>
                  <p className="text-[#1a1a1a] font-medium">{product.lumens}</p>
                </div>
                <div>
                  <span className="text-[#757575]">전압</span>
                  <p className="text-[#1a1a1a] font-medium">{product.voltage}</p>
                </div>
                <div>
                  <span className="text-[#757575]">에너지 등급</span>
                  <p className="text-[#1a1a1a] font-medium">{product.energyRating}</p>
                </div>
                <div>
                  <span className="text-[#757575]">크기</span>
                  <p className="text-[#1a1a1a] font-medium">{product.dimensions}</p>
                </div>
              </div>
              <div className="mt-3 pt-3 border-t border-[#e1e1e1]">
                <span className="text-[#757575] text-[13px]">설치 방법</span>
                <p className="text-[#1a1a1a] font-medium text-[13px]">{product.installationMethod}</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="bg-[#ffffff] shadow-[0px_0px_20px_0px_rgba(0,0,0,0.1)] absolute bottom-0 left-0 right-0 h-[100px]">
        <div className="absolute left-6 right-6 top-6">
          <div className="box-border content-stretch flex flex-row gap-4 items-center justify-start p-0 relative w-full">
            ...
            <div className="basis-0 bg-[#1a1a1a] grow min-h-px min-w-px relative rounded-lg shrink-0">
              <button
              ...
              >
                <div className="box-border content-stretch flex flex-row gap-2 items-center justify-start pl-6 pr-4 py-2 relative w-full">
                  <div className="basis-0 flex flex-col font-['Inter:Regular',_sans-serif] font-normal grow justify-center leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[#ffffff] text-[16px] text-left tracking-[-0.16px]">
                    <p className="block leading-[24px] text-[14px]">장바구니 담기</p>
                  </div>
  ...
  return (
    <div className="absolute bg-[#ffffff] h-[149px] left-0 right-0 top-0">
      ...
      <div className="absolute bg-[#ffffff] h-16 left-0 overflow-clip right-0 top-[31px]">
        ...
        <div
          className="absolute flex flex-col font-['Newsreader:Medium',_sans-serif] font-medium justify-center leading-[0] text-[#1a1a1a] text-[24px] text-center text-nowrap top-9 tracking-[-0.24px] translate-x-[-50%] translate-y-[-50%]"
        ...
        <div className="box-border content-stretch flex flex-col gap-4 items-end justify-end p-0 relative w-full">
          <div className="relative shrink-0 w-full">
            <div className="box-border content-stretch flex flex-row font-normal items-center justify-start leading-[0] p-0 relative text-left w-full">
              ...
              <button 
                onClick={onBack}
                className="cursor-pointer flex flex-row items-center gap-1 font-['Inter:Regular',_sans-serif] justify-center not-italic relative shrink-0 text-[#1a1a1a] text-[14px] text-nowrap tracking-[-0.14px]"
              >
                <svg width="12" height="12" viewBox="0 0 12 12" fill="none" className="shrink-0">
                  <path d="M7.5 2.5L4 6L7.5 9.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
                <span className="adjustLetterSpacing leading-[24px]">뒤로</span>
              </button>
            </div>
          </div>
        </div>
