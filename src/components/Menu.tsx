...
function MenuItems({ onNavigate }: MenuItemsProps) {
  const menuItems = [
    { label: "쇼핑", screen: "list" },
    { label: "AI 공간 분석", screen: "roomAnalyzer" },
    { label: "뉴스", screen: "newsstand" },
    { label: "회사 소개", screen: "about" },
    { label: "내 프로필", screen: "profile" },
    { label: "장바구니", screen: "basket" },
  ];
